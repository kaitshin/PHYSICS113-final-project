...
We see that our $\alpha,\ \alpha',\ \beta$, and $\gamma$ are in good agreement with the literature.
...
\begin{figure}
	...
	\caption{\label{fig:vortices} Examples of a single vortex (lower left) and anti-vortex (upper right)  in the XY model.}
\end{figure}
...
The entire project was a collaborative effort, each person regularly reviewing or helping out with the other person's code.
